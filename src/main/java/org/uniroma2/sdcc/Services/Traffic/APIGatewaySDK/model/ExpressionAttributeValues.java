...
import org.uniroma2.sdcc.Services.Traffic.APIGatewaySDK.model.transform.ExpressionAttributeValuesMarshaller;
...
public class ExpressionAttributeValues implements Serializable, Cloneable, StructuredPojo {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        ExpressionAttributeValuesMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
