...
import org.uniroma2.sdcc.Services.Traffic.APIGatewaySDK.model.transform.ItemsItemMarshaller;

/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/gswnejacse-2017-04-07T09:59:10Z/ItemsItem" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ItemsItem implements Serializable, Cloneable, StructuredPojo {
    ...
    public ItemsItem city(String city) {
        setCity(city);
        return this;
    }
    ...
    public ItemsItem street(String street) {
        setStreet(street);
        return this;
    }
    ...
    public ItemsItem trafficPerc(Double trafficPerc) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ItemsItem == false)
            return false;
        ItemsItem other = (ItemsItem) obj;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        ItemsItemMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
