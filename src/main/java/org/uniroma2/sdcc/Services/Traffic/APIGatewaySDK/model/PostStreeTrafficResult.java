...
public class PostStreeTrafficResult extends com.amazonaws.opensdk.BaseResult implements Serializable, Cloneable {
    ...
    public PostStreeTrafficResult empty(Empty empty) {
        setEmpty(empty);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PostStreeTrafficResult == false)
            return false;
        PostStreeTrafficResult other = (PostStreeTrafficResult) obj;
    ...
    @Override
    public PostStreeTrafficResult clone() {
        try {
            return (PostStreeTrafficResult) super.clone();
