...
public class PutStreeTrafficResult extends com.amazonaws.opensdk.BaseResult implements Serializable, Cloneable {
    ...
    public PutStreeTrafficResult empty(Empty empty) {
        setEmpty(empty);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutStreeTrafficResult == false)
            return false;
        PutStreeTrafficResult other = (PutStreeTrafficResult) obj;
    ...
    @Override
    public PutStreeTrafficResult clone() {
        try {
            return (PutStreeTrafficResult) super.clone();
